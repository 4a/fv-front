const embed = {
	"getHtml": (url) => `<iframe src='${url}' frameborder=0 scrolling='no' allowfullscreen></iframe>`,
	...
	"htv": {
		...
		"getStream": (channel) => embed.getHtml(`http://www.hitbox.tv/embed/${channel}?popout=true&autoplay=true`),
		"getVod": (video) => embed.getHtml(`//player.twitch.tv/?autoplay=true&video=${video}`)
	}
}
